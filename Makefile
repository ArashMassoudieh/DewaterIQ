#############################################################################
# Makefile for building: DewaterIQ
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  DewaterIQ.pro
# Template: app
# Command: /home/arash/Qt/5.15.2/gcc_64/bin/qmake -o Makefile DewaterIQ.pro -spec linux-g++ CONFIG+=qtquickcompiler
#############################################################################
...
INCPATH       = -I. -I../../Qt/5.15.2/gcc_64/include -I../../Qt/5.15.2/gcc_64/include/QtGui -I../../Qt/5.15.2/gcc_64/include/QtCore -I. -I/usr/include/libdrm -I../../Qt/5.15.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/arash/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/arash/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/arash/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = DewaterIQ1.0.0
DISTDIR = /home/arash/Projects/DewaterIQ/.tmp/DewaterIQ1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/arash/Qt/5.15.2/gcc_64/lib
LIBS          = $(SUBLIBS) /home/arash/Qt/5.15.2/gcc_64/lib/libQt5Gui.so /home/arash/Qt/5.15.2/gcc_64/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		DewaterIQ.pro AquaArray.h \
		DataStructure.h \
		ExpressionCalculator.h \
		ExpressionCalculator.hpp \
		System.h \
		aquatable.h AquaArray.cpp \
		DataStructure.cpp \
		ExpressionCalculator.cpp \
		System.cpp \
		aquatable.cpp \
		main.cpp
QMAKE_TARGET  = DewaterIQ
DESTDIR       = 
TARGET        = DewaterIQ
...
Makefile: DewaterIQ.pro ../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		DewaterIQ.pro
	$(QMAKE) -o Makefile DewaterIQ.pro -spec linux-g++ CONFIG+=qtquickcompiler
...
distdir: FORCE
	...
	$(COPY_FILE) --parents AquaArray.h DataStructure.h ExpressionCalculator.h ExpressionCalculator.hpp System.h aquatable.h $(DISTDIR)/
	$(COPY_FILE) --parents AquaArray.cpp DataStructure.cpp ExpressionCalculator.cpp System.cpp aquatable.cpp main.cpp $(DISTDIR)/
...
AquaArray.o: AquaArray.cpp AquaArray.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AquaArray.o AquaArray.cpp
...
ExpressionCalculator.o: ExpressionCalculator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ExpressionCalculator.o ExpressionCalculator.cpp
...
aquatable.o: aquatable.cpp aquatable.h \
		AquaArray.h \
		../../Qt/5.15.2/gcc_64/include/QtCore/QVector \
		../../Qt/5.15.2/gcc_64/include/QtCore/qvector.h \
		../../Qt/5.15.2/gcc_64/include/QtCore/qalgorithms.h \
		...
		../../Qt/5.15.2/gcc_64/include/QtCore/QJsonObject \
		../../Qt/5.15.2/gcc_64/include/QtCore/qjsonobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o aquatable.o aquatable.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/DewaterIQ/bin || mkdir -p $(INSTALL_ROOT)/opt/DewaterIQ/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/DewaterIQ/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/DewaterIQ/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/DewaterIQ/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/DewaterIQ/bin/ 
